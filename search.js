...
//the main code for the AI
			...
			function sort()
			{
				...
				for(var i=0;i<phrases.length;i++){
					//sort each words and where they link to.
				     var splitted = ((phrases[i].replace("â†µ", "").split(',')[0]).split(':')); //get splitted words
		...
		function getVisited(word){
			...
			console.log("cookie: "+((document.cookie.replace("â†µ", "")).replace("; expires=Thu, 01 Jan 2037 00:00:01 GMT;", "")).replace("content=","")+"ENDCOOKIE"); //output the file
					  ...
					  if(learn == false)
					  {
					  	if(checker==true){ //do this once
							if(textFile==null){
							  ...
							  textFile=textFile+((document.cookie.replace("â†µ", "")).replace("; expires=Thu, 01 Jan 2037 00:00:01 GMT;", "")).replace("content=","") ; //format of data
						  }	
							checker=false;
						}
